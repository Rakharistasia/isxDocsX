...
> where a real example helps. [`08_Examples.md`](08_Examples.md) shows complete, game-specific
> scripts.
...
This rule is important enough that it also appears in [`07_Migration_Gotchas.md`](07_Migration_Gotchas.md).
